...
import com.epam.training.facades.UserRegisterFacade;
import com.epam.training.storefront.forms.RegisterFormWithOrganization;
import com.epam.training.storefront.forms.validation.ExtendedRegistrationValidator;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	@Resource(name="userRegisterFacade")
	...
	public Collection<OrganizationData> getOrganizations() {
		return userRegisterFacade.getOrganizations();
	}
	...
	protected String getDefaultLoginPage(boolean loginError, HttpSession session, Model model) throws CMSItemNotFoundException {
		...
		model.addAttribute("registerForm", new RegisterFormWithOrganization());
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer, final RegisterFormWithOrganization form,
	...
	protected Validator getRegistrationValidator() {
		return new ExtendedRegistrationValidator();
	}
}