...
public class TraininghmcManager extends GeneratedTraininghmcManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(TraininghmcManager.class);
	...
	public void init()
	{
		LOG.debug("init() of TraininghmcManager called, current tenant: {}", getTenant().getTenantID());
	}
