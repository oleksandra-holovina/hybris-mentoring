...
public class DefaultTrainingorganizationsService implements TrainingorganizationsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingorganizationsService.class);
	...
	{
		return DefaultTrainingorganizationsService.class.getResourceAsStream("/trainingorganizations/sap-hybris-platform.png");
	}
