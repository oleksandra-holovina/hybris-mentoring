...
/**
 * This is the extension manager of the Trainingorganizations extension.
 */
public class TrainingorganizationsManager extends GeneratedTrainingorganizationsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TrainingorganizationsManager.class);
	 ...
	 */
	public static TrainingorganizationsManager getInstance()
	{
		return (TrainingorganizationsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingorganizationsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingorganizationsManager() // NOPMD 
	{
		LOG.debug("constructor of TrainingorganizationsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TrainingorganizationsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TrainingorganizationsManager called, current tenant: {}", getTenant().getTenantID());
	}
