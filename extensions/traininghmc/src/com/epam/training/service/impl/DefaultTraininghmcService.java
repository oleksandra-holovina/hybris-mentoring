...
public class DefaultTraininghmcService implements TraininghmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTraininghmcService.class);
	...
	{
		return DefaultTraininghmcService.class.getResourceAsStream("/traininghmc/sap-hybris-platform.png");
	}
